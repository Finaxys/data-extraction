...
//	{
//		Exchange e = new Exchange("mic_get", "symbol_get", "suffixe_get", 2, "Test Exchange get", "Interne Type get", "Europe", "France", "USD/EUR", 5, 6, true);
...
//		Exchange result = exDao.get(0, "suffixe_get", "mic_get");
...
//		Exchange result = exDao.get(20, "suffixe_get", "micet");
//		assertTrue(result == null);
//	}
//	
//	@Test
...
//		Exchange result = exDao.get(0, "suffet", "mic_get");
//		assertTrue(result == null);
//		
//		System.out.println("				________________________________________");
//	}
