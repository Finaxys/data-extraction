...
import com.finaxys.rd.dataextraction.service.RatesService;
...
public class RatesServiceImpl implements RatesService {
	 ...
	 */
	public RatesServiceImpl(RateProvider provider, Converter converter, Publisher publisher, String routingKey,
	 ...
	 * @return the provider
	 */
	public RateProvider getProvider() {
		return provider;
	}
	...
	public void publishRates() {
		...
		List<Document> l;
		try {
			l = this.provider.getRates(this.contentType);
			if (l != null)
			for (Document d : l) {
